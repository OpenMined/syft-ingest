...
def test_gather_local_directory():
    ...
    with patch("syft_ingest.sources.local.fetch_local") as mock_fetch_local:
        ...
        mock_fetch_local.assert_called_once_with(["/tmp/test"], author="Local Creator")


def test_gather_handles_fetch_error():
